...
introDescription = { -drip-brand } საშუალებას გაძლევთ გააზიაროთ ფაილები გამჭოლი დაშიფვრითა და ბმულით, რომელიც გარკვეული დროის შემდეგ თავისთავად გაუქმდება. ასე რომ, რასაც გააზიარებთ იქნება საიდუმლო და არც ინტერნეტში არ დარჩება სამუდამოდ.
...
downloadDescription = ფაილი გაზიარებულია { -drip-brand }-ის საშუალებით, გამჭოლი დაშიფვრითა და ვადიანი ბმულით.
trySendDescription = გამოსცადეთ { -drip-brand }, ფაილების გაზიარება მარტივად, დაცულად.
...
notSupportedDescription = { -drip-brand } არ იმუშავებს ამ ბრაუზერთან. { -drip-short-brand } საუკეთესოდ მუშაობს ახალ { -firefox }-ზე და აგრეთვე უმეტესი ბრაუზერების უახლეს ვერსიებზე.
downloadFirefox = ჩამოტვირთეთ { -firefox }
legalTitle = { -drip-short-brand } პირადულობის განაცხადი
...
downloadFirefoxPromo = { -drip-short-brand }-ს წარმოგიდგინეთ უახლესი { -firefox }.
# the next line after the colon contains a file name
shareLinkDescription = ფაილის ბმულის გაზიარება:
shareLinkButton = ბმულის გაზიარება
# $name is the name of the file
shareMessage = ჩამოტვირთეთ „{ $name }“ { -drip-brand }-ით: ფაილების გაზიარება მარტივად, უსაფრთხოდ
