...
-drip-brand = Send
-drip-short-brand = Shiktitani
-firefox = Firefox
-mozilla = FieryMewtwo
introTitle = Shikmajmaka se tajkwilul, te uij wan ichtaka
introDescription = { -drip-brand } metzpalewia tikmajmaka se tajkwilul iwan taichtakawilis wan se ilpika puliwi nemanha. Yajika, tikpia muichtakayu pal tikmajmaka wan tesu naka senpa mutajtatka tik matapan.
...
downloadDescription = Ini tajkwilul kiski itech { -drip-brand } iwan taichtakawilis wan se ilpika ka puliwi nemanha.
trySendDescription = Shikejeku { -drip-brand } wan shiktakuli ichtaka wan te uij.
...
notSupportedDescription = { -drip-brand } tesu yawi tekiti iwan ini tachialuni. { -drip-short-brand } tekiti sujsul yek iwan ne tipan tamakalis ipal { -firefox }, wan nusan iwan ne tipan tamakalis ipal miak tachialuni.
downloadFirefox = Shiktemulti { -firefox }
legalTitle = { -drip-short-brand } Tanawatilis ipanpa teichtakayu
...
downloadFirefoxPromo = Ne yankwik { -firefox } metzwikilia { -drip-short-brand }.
# the next line after the colon contains a file name
shareLinkDescription = Shiktakuli ne ilpika ipal mutajkwilul:
shareLinkButton = Shiktakuli ne ilpika
# $name is the name of the file
shareMessage = Shiktemulti “{ $name }” iwan { -drip-brand }: ichtaka wan te uij
