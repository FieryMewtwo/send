...
introDescription = { -drip-brand } te permite compartir archivos con cifrado de extremo a extremo y un enlace que caduca automáticamente. Así puedes mantener en privado lo que compartes y asegurarte de que tus cosas no permanezcan en línea para siempre.
...
downloadDescription = Este archivo fue compartido vía { -drip-brand } con un cifrado de punto a punto y un enlace que expira automáticamente.
trySendDescription = Intenta con { -drip-brand } para compartir fácil y seguro.
...
notSupportedDescription = { -drip-brand } no funcionará con este navegador. { -drip-short-brand } trabaja mejor que la última versión de { -firefox }, y trabajará con la versión actual de la mayoría de la navegadores.
...
downloadFirefoxPromo = { -drip-short-brand } te lo ofrece el nuevo { -firefox }.
# the next line after the colon contains a file name
shareLinkDescription = Comparte el enlace a tu archivo:
shareLinkButton = Enlace para compartir
# $name is the name of the file
shareMessage = Descarga «{ $name }» con { -drip-brand }: es sencillo y seguro
