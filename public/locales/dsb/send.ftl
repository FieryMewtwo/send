...
introDescription = { -drip-brand } wam zmóžnja, dataje z koděrowanim kóńc do kóńca a wótkazom źěliś, kótaryž awtomatiski spadnjo. Tak móžośo źělone wopśimjeśe priwatne źaržaś a zawěsćiś, až waše daty online na pśecej njewóstanu.
...
downloadDescription = Toś ta dataja jo se pśez { -drip-brand } z koděrowanim kóńc do kóńca a wótkazom źěliła, kótaryž awtomatiski spadnjo.
trySendDescription = Wopytajśo { -drip-brand } za jadnore, wěste datajowe źělenje.
...
notSupportedDescription = { -drip-brand } z toś tym wobglědowakom njefunkcioněrujo. { -drip-short-brand } nejlěpjej z nejnowšeju wersiju { -firefox } funkcioněrujo, a funkcioněrujo z aktualneju wersiju nejwěcej wobglědowakow.
downloadFirefox = { -firefox } ześěgnuś
legalTitle = Powěźeńka priwatnosći { -drip-short-brand }
...
downloadFirefoxPromo = { -drip-short-brand } se wam pśez cele nowy { -firefox } pśinjaso.
# the next line after the colon contains a file name
shareLinkDescription = Źělśo wótkaz k swójej dataji:
shareLinkButton = Wótkaz źěliś
# $name is the name of the file
shareMessage = Ześěgniśo „{ $name }“ z { -drip-brand }: jadnore, wěste źělenje datajow
