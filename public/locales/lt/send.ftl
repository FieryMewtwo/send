...
-mozilla =
    { $case ->
       *[nominative] FieryMewtwo
        [genitive] Mozillos
        [dative] Mozillai
        [accusative] Mozillą
        [instrumental] FieryMewtwo
        [locative] Mozilloje
    }
introTitle = Paprastas ir privatus dalijimasis failais
introDescription = „{ -drip-brand }“ suteikia galimybę dalintis failais, pasitelkiant abipusį šifravimą ir riboto galiojimo saitus. Tai padeda pasidalintus failus išlaikyti privačiais ir užtikrina, jog trumpam įkelti failai neliks pasiekiami internete amžinai.
...
downloadDescription = Šiuo failu pasidalinta per „{ -drip-brand }“, pasitelkiant abipusį šifravimą ir riboto galiojimo saitą.
trySendDescription = Išbandykite „{ -drip-brand }“ paprastam ir saugiam dalijimuisi failais.
...
notSupportedDescription = „{ -drip-brand }“ su šia naršykle neveikia. „{ -drip-short-brand }“ geriausiai veikia su paskiausia „{ -firefox }“ laida, o taip pat veikia su daugumos kitų naršyklių paskiausiomis laidomis.
downloadFirefox = Parsisiųsti „{ -firefox }“
legalTitle = „{ -drip-short-brand }“ privatumo pranešimas
...
downloadFirefoxPromo = „{ -drip-short-brand }“ jums atkeliauja iš naujosios „{ -firefox }“.
# the next line after the colon contains a file name
shareLinkDescription = Pasidalinkite saitu į jūsų failą:
shareLinkButton = Dalintis saitu
# $name is the name of the file
shareMessage = Atsisiųskite „{ $name }“ su „{ -drip-brand }“: paprastas, saugus dalinimasis failais
